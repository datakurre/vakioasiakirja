...
% Otsikkorivin ja rungon erottavat vaakaviivat kuten pandocin tuottamassa
% markdown-vastineessa; pidetään latex- ja markdown-taulukot samannäköisinä.
\usepackage{booktabs}
...
% Lisäksi korostuksia (lihavointi, matematiikka) ja sisennetty lainaus,
% jotka vastaavat markdown-version vastaavia merkintöjä.

\logo{\includegraphics{logo-organisaatio}}
\doctype{Raportti}
\date{31.5.2024}
\modified{5.6.2024}% PDF ModDate; CreationDate comes from \date
\author{Virve Virtanen}
\docid{Dnro 45/2024}
\keywords{asiakaspalaute, kysely, digiprojekti}% PDF Keywords
...
Selvästi yleisin kehitystoive koski \textbf{verkkosivuston etusivua}:
