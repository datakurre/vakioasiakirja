...
\item[\textbackslash date\{15.5.2024\}] The date (päivämäärä). Write as
  \texttt{d.m.yyyy} without leading zeros, per SFS 4175.
...
\item[\textbackslash logo\{\ldots\}] The organization logo, as any box:
  ...
  grows automatically to fit a tall logo.
...
subject, author and document language \texttt{fi} --- for accessibility
...
Bullet lists are preconfigured (bullet markers, tight item spacing, one
