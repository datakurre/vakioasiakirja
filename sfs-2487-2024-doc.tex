...
\item[no-runin] Always start body text on its own line below the
  heading. By default a heading or margin label that fits inside the
  2,3\,cm heading column shares its line with the body text, as in the
  standard's own model documents.
