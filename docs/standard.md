...
| 6.5.3 Luettelot | Lists made with the list tool, indented, separated from text by at least one paragraph gap, at least one space after the marker | Preconfigured *enumitem* lists: one paragraph gap above/below, indented items marked with the en dash of Finnish convention; spacing overridable per list |
